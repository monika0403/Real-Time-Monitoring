...
<div class="container">
  ...
  <div class="col-sm-8">
   <label for="fname">District Name</label>
    <input type="text" id="dname" name="dname"  placeholder="Your district name..">
	
	 <label for="fname">Block Name</label>
    <input type="text" id="bname" name="bname"  placeholder="Your block name..">
	
	 <label for="fname">Village Panchayat</label>
    <input type="text" id="vp" name="vp"   placeholder="Your village panchayat..">
  </div>
 ...
 adhhar <input type="file" name="adhhar" accept="image/*">
  ...
  <%String hos = request.getParameter("hospital"); %>
   <label for="hospital">Hospital</label>
    <input type="text" id="hospital" name="hospital"  value="<%=hos%>" placeholder="Hospital Name">
    
    <label for="fname">Name of applicant</label>
    <input type="text" id="name" name="name"  placeholder="Your name..">

    <label for="lname">Father/Husband's Name</label>
    <input type="text" id="fhname" name="fhname"  placeholder="Your father/husband's name..">
    
     <label for="schemeCode">SchemeCode</label>
    <input type="text" id="schemeCode" name="schemeCode"  placeholder="Your scheme code..">
    ...
    <input type="text" id="contact" name="contact"  placeholder="Your contact name..">
	
	
	<label for="date">Date of Birth</label><br>
    <input type="date" id="date" name="date"  placeholder="Your date of birth..">
	
	<br><br>
	<label for="contact">Aadhar Number</label>
    <input type="text" id="contact" name="addhar"  placeholder="Aadhar number..">
